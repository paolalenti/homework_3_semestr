...
public class ServletListener implements ServletContextListener {
    ...
    public void contextInitialized(ServletContextEvent sce) {
        ...
        System.out.println("ServletListener: freemarkerConfiguration Bean is ready");
        ...
        sce.getServletContext().setAttribute("freemarkerConfiguration", configuration);
        System.out.println("ServletListener: freemarkerConfiguration Bean is accessed for servlets");
